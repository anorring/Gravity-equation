...
The standard procedure has long been simply taking natural logs of the equation and estimate the obtained log-linear equations using OLS. 

$ln X_{ijt} = ln G_t + ln S__{ijt} + ln M__{ijt} + ln \phi_{ijt}$
